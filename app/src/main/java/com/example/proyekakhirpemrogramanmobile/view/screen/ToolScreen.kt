...
import com.example.proyekakhirpemrogramanmobile.data.listTool
import com.example.proyekakhirpemrogramanmobile.model.ToolModel
...
fun ToolScreen() {
    ...
    val selectedMenu = R.string.sidebar_tool
