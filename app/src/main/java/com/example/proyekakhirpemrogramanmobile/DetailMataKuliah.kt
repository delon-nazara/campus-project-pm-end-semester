...
fun getDetailMataKuliah(): List<DetailMataKuliah>{
    return listOf<DetailMataKuliah>(
            DetailMataKuliah("Pemrograman Mobile", "Steven Anthony", "35",5,R.drawable.laptop_icon),
            DetailMataKuliah("Grafika Komputer", "Iqbal Alwi", "29",5,R.drawable.laptop_icon),
            DetailMataKuliah("Algoritma Pemrograman", "Delon Nazara", "78",5,R.drawable.laptop_icon),
    )
}